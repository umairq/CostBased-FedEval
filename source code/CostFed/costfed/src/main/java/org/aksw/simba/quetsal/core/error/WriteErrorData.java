...
public class WriteErrorData {
    ...
    public static String approach_name = "CostFed";
    public static String file_name = approach_name+"-RelativeError.txt";
...
//    public static String queryPlanTxt =  aksw_res+"query#"+ q_name +">  <"+aksw_schema+"queryPlan> ";
    ...
    public static void calculateSimilarity(){
            ...
            try {
                ...
                writeToFile("\n\n" +
                        plan + "\"" +SimilarityConstants.calculateAngleBetweenVector()+ "\""+literal_type+".\n\n");
            } catch (IOException e) {
                e.printStackTrace();
            }
