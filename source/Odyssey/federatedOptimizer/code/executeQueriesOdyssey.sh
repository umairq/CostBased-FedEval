...
fedBench=/home/MuhammadSaleem/umair/evaluation/odeyssey/roott/queries/fedBench
...
#    l="${l} q${i}"
#done
l="S9 S8 S6 S5 S4 S3 S2 S14 S13 S12 S11 S1 C8 C7 C5 C4 C3 C2 C1"
#s=`seq 1 7`
...
for query in ${l}; do
    ...
    for j in `seq 1 ${n}`; do
        ...
        /usr/bin/time -f "%e %P %t %M" timeout ${w}s java -Xmx4096m -cp .:${JENA_HOME}/lib/*:${ODYSSEY_HOME}/lib/fedX3.1/lib/* evaluateSPARQLQuery $fedBench/$query ${datasets} ${fedBenchDataPath} 100000000 true false $newQueries/$query $errorFilePath false > outputFile 2> timeFile
