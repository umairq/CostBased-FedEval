...
public class QueryEvaluationFeasible<repo> {
...
//	{	
 ...
 //   if(args[0].equals("-qr")){
    ...
    while(res.hasNext() && (System.currentTimeMillis()-sTime)<timeout)  
	{
      ...
      } catch(Exception ex){ System.out.println(" error in running query. processing bypassed .."+ex); bw.write(" error in running query. processing bypassed ..\n"); }
