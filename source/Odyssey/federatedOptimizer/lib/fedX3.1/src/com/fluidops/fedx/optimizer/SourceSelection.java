...
import org.aksw.simba.start.SourceSelectionOnly;
...
//			try {
//			//	QueryEvaluation.bw.write("Number of ASK request: 0"+"\n");
//			} catch (IOException e) {
...
//System.out.println(stmtToSources.get(stmt));
		...
		// try {
			//SourceSelectionOnly.bw.write("Total Triple Pattern-wise selected sources: " + triplePatternWiseSources+"\n");
			//SourceSelectionOnly.totalTpSources = SourceSelectionOnly.totalTpSources+ triplePatternWiseSources;
		//} catch (IOException e) {
			// TODO Auto-generated catch block
	//		e.printStackTrace();
		//}
