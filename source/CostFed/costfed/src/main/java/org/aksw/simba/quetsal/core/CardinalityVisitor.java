...
public class CardinalityVisitor extends AbstractQueryModelVisitor<RuntimeException>
{
	...
	public static class CardPair {
		...
		public CardPair(CardPair estimatedCord) {
			this.nd = estimatedCord.nd;
			this.expr = estimatedCord.expr;
	...
	public static class JoinCard{
        public TupleExpr expr1;
        public TupleExpr expr2;
        public NodeDescriptor nd;

        public JoinCard(TupleExpr te, TupleExpr te2, NodeDescriptor nd) {
            this.expr1 = te;
            this.expr2 = te2;
            this.nd = nd;
        }
        ...
        @Override
        public String toString() {
            return String.format("CardPair [expr1=%s,expr2=%s, card=%s, mvs=%s, mvo=%s", expr1,expr2, nd.card, nd.mvsbjkoef, nd.mvobjkoef);
        }
    }
	...
	public void meet(StatementPattern stmt) {
		...
		// added by Umair
//		long orignalCard = Cardinality.getTriplePatternCardinalityOriginal(getSummaryConnection(),stmt,stmtSrces);
//		if(orignalCard!=0)
//			System.out.println("Relative Error: "+stmt + "\n" + "cord:" + current.card +
//					", and orignal cord:" + orignalCard + " , Relative Error:" +
//					RelativeError.getRelativeError(current.card,orignalCard));
	}
